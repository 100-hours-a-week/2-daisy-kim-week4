...
근데 원래 리액트에서도 됐던 건데 왜 서버측 동작이라고 생각했던 건지 지금 와서 생각해 보니 의문 ㅎ<br>
그리고 피그마 대로 px 맞춰서 구현하면 사진이 찌부돼서 나오는데 이것도 사진을 잘라야 하는 건지 사진이 길어도 길게 출력하도록 해야 하는 건지 몰라서 그냥 height도 냅다 고정시켜버림
...
(아 근데 백엔드 6주차에 한다고 한다. 그럼 다음주 과제로 프론트는 뭐를 더하는 거지?)<br>
TIL 밀린 건... 언제 하지...흠냐링..~
